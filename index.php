    ...
    <div class="destinations-container">
      ...
      <div class="destination-card">
        <a href="index.php?page_layout=hanquoc">
          <img src="img/img_diadiem/du-lich-han-quoc.jpg" alt="Hàn Quốc" />
          <div class="overlay">
      ...
      <div class="destination-card">
        <a href="index.php?page_layout=thailan">
          <img src="img/img_diadiem/thailan.jpeg" alt="Thái Lan" />
          <div class="overlay">
      ...
      <div class="destination-card">
        <a href="index.php?page_layout=trungquoc">
          <img src="img/img_diadiem/trungquoc.jpg" alt="Trung Quốc" />
          <div class="overlay">
  ...
  <section class="filter_price">
    <form method="GET" action="filter_price.php">
      <select name="price_range">
        ...
        <option value="2">1,000,000 - 3,000,000 VNĐ</option>
        <option value="3">3,000,000 - 5,000,000 VNĐ</option>
        <option value="4">Trên 5,000,000 VNĐ</option>
      </select>
      <button name="page_layout/filter_tour" type="submit">Lọc</button>
    </form>
  </section>
  <!-- Tour trong nước -->
